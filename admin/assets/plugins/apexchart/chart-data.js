...
if ($('#chart-col-1').length > 0) {
  var sCol = {
    ...
    series: [{
      name: 'Data',
      data: [42, 55, 50, 60, 48, 65, 60] // You can adjust these
    }],
    xaxis: {
      labels: { show: false },
      axisTicks: { show: false },
...
if ($('#chart-col-2').length > 0) {
  var sCol = {
    ...
    series: [{
      name: 'Data',
      data: [23, 36, 34, 45, 28, 46, 45] // You can adjust these
    }],
    xaxis: {
      labels: { show: false },
      axisTicks: { show: false },
...
if ($('#chart-col-3').length > 0) {
  var sCol = {
    ...
    series: [{
      name: 'Data',
      data: [32, 45, 40, 50, 38, 55, 50] // You can adjust these
    }],
    xaxis: {
      labels: { show: false },
      axisTicks: { show: false },
...
if ($('#chart-col-4').length > 0) {
  var sCol = {
    ...
    series: [{
      name: 'Data',
      data: [22, 45, 40, 62, 78, 45, 80] // You can adjust these
    }],
    xaxis: {
      labels: { show: false },
      axisTicks: { show: false },
